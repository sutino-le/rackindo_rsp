...
<body>
    ...
    $jumlah = null;
    //Query SQL
    $sql = "SELECT bagian.bagian_nama, karyawan.karyawan_bagian,COUNT(*) AS 'total_bagian' FROM karyawan JOIN bagian ON karyawan.karyawan_bagian=bagian.bagian_id WHERE karyawan.karyawan_kategori='Karyawan' GROUP by karyawan.karyawan_bagian ASC";
