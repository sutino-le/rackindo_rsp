...
<div class="container-fluid">
    <button onclick="document.getElementById('001').style.display='block'" type="button" title="Add Career"
        class="btn btn-info btn-sm"><i class='fas fa-plus'></i></button> Add Extra Salary
</div>
...
<div class="container-fluid">
    <br>
    <table id="addition_data" class="table table-hover" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th>NO.</th>
                <th>Pin</th>
...
<div id="001" class="w3-modal small">
    <div class="w3-modal-content w3-animate-top w3-card-4">
        <header class="w3-container w3-teal">
            ...
            <h3>Add Extra Salary</h3>
        </header>
        <form action="home_admin.php?page=addition_input" method="POST">

            <div class="w3-container">
                <br>
                <div class="form-group">
                    Select Employee
                    <select class="form-control" name="upah_tambahan_ktp" id="upah_tambahan_ktp" required>
                ...
                <div class="form-group">
                    Date
                    <input type="date" name="upah_tambahan_tanggal" id="upah_tambahan_tanggal" class="form-control"
                        required>
                </div>

                <div class="form-group">
                    Addition
                    <input type="text" name="upah_tambahan_jumlah" id="upah_tambahan_jumlah" class="form-control"
                        required>
                </div>
            </div>
