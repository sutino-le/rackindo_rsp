...
$daftar_karyawan = mysql_query("SELECT * FROM karyawan JOIN biodata_ktp ON karyawan.karyawan_ktp=biodata_ktp.ktp_nomor JOIN bagian ON karyawan.karyawan_bagian=bagian.bagian_id WHERE karyawan.karyawan_bagian='$bagian' AND karyawan.karyawan_status='Aktif' OR karyawan.karyawan_status='Keluar' AND karyawan.karyawan_terminate BETWEEN '$periode_awal' AND '$periode_akhir' AND  karyawan.karyawan_bagian='$bagian'  ORDER BY karyawan.karyawan_jabatan, karyawan.karyawan_finger ASC ");
