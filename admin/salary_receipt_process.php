                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-honeydew">
                            ...
                            <table width="100%" border="1">
                                <tr>
                                    <td colspan="3" bgcolor="#3bc190" align="center"><b><?php echo $bagian_nama; ?></b>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" bgcolor="#3bc190">No</td>
                                    <td align="center" bgcolor="#3bc190">Nama</td>
                                    <td align="center" bgcolor="#3bc190">TTD</td>
                                </tr>
                                <?php
                                        ...
                                        while ($v_dakar = mysql_fetch_array($dakar)) {
                                            ...
                                            if ($v_dakar['karyawan_jenis'] == "Permanent") {
                                                $b1 = "<b>";
                                                $b2 = "</b>";
                                            } else {
                                                $b1 = "";
