                        ...
                        <tbody>
                            ...
                            while ($biodata_ktp = mysql_fetch_array($query)) {
                                ...
                                $karyawan_status = $biodata_ktp['karyawan_status']; {
                                    ...
                                    $query_bpjstk = mysql_query("SELECT * FROM bpjs_tk WHERE bpjstk_ktp='$nik' ORDER BY bpjstk_masuk ASC ");
                                    $data_bpjstk = mysql_fetch_array($query_bpjstk);

                                    $bpjstk_status = $data_bpjstk['bpjstk_status'];

                                    if (empty($karyawan_status)) {
                                        $tombol = "";
                                    } else if ($bpjstk_status == "Progres") {
                                        $tombol = "Disabled";
                                    }

                                    if (empty($bpjstk_status)) {
                                ...
                                <td>
                                    ...
                                    <div id="<?php echo $nik; ?>" class="w3-modal small">
                                        <div class="w3-modal-content w3-animate-top w3-card-4">
                                            ...
                                            <form action="home_admin.php?page=bpjstk_register_process" method="POST">
                                                <input type="hidden" name="bpjstk_ktp" value="<?php echo $nik; ?>">

                                                <div class="w3-container">
                                                    <br>
                                                    <div class="form-group">
                                                        Register Date
                                                        <input type="date" name="bpjstk_masuk" class="form-control"
                                                            required>
                                                    </div>
