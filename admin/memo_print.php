...
<table width="50%" height="793" border="0" background="img/bacgkground-logo.jpg">
    <tr height="151">
        <td valign="top">
            <hr size="4px" color="#20B2AA">
            <table width="100%">
                <tr>
                    <td width="20%" align="right"><img src="asset/dist/img/logo.png" width="60" height="60"></td>
                ...
                <tr valign="top">
                    ...
                    <td width="50%">
                        <font size="2" color="gray">021 5595 1295 / 5595 1393 / 5595 8524 / 55958527 <br>021 2255 6109
                            <br>www.rackindo-furniture.com </font>
                    </td>
