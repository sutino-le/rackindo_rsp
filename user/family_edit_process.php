...
$query_keluarga = mysql_query("SELECT * FROM biodata_keluarga WHERE keluarga_ktp='$keluarga_ktp' AND keluarga_jenis='$keluarga_jenis' ");
$hasil = mysql_fetch_array($query_keluarga);
if (empty($hasil)) {
    $query_keluarga = mysql_query("INSERT INTO biodata_keluarga VALUES('', '$keluarga_ktp', '$keluarga_jenis', '$keluarga_nama', '$keluarga_lahir', '$keluarga_kelamin', '$keluarga_alamat', '$keluarga_hp', '$keluarga_nomor' )");
} else {
    //input data keluarga 
    $query_keluarga = mysql_query("UPDATE keluarga SET
	...
	WHERE 
	keluarga_ktp='$keluarga_ktp' AND keluarga_jenis='$keluarga_jenis'
");
}
